import { Modify, JsonUIElement, FontType } from 'jsonui-scripting';
...
Modify.PersonaCommon('gamepad_hotkey_helpers/quick_select_gamepad_helpers/gamepad_x').setProperty({ layer: 11, offset: [0, 0], size: [8, 8] })
Modify.PersonaCommon('gamepad_hotkey_helpers/quick_select_gamepad_helpers/gamepad_y').setProperty({ layer: 12, offset: [0, 0], size: [8, 8] })
Modify.PersonaCommon('gamepad_hotkey_helpers/quick_select_gamepad_helpers/gamepad_a').setProperty({ layer: 13, offset: [0, 0], size: [8, 8] })
Modify.PersonaCommon('gamepad_hotkey_helpers/quick_select_gamepad_helpers/gamepad_b').setProperty({ layer: 14, offset: [0, 0], size: [8, 8] })
